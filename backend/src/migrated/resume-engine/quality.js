...
export function resumeQualityCheck(content, options = {}) {
  ...
  return {
    ...
    target: `校园求职：核心内容和 HR 可读性优先，${targetPages} 页为硬交付指标`,
    writingGuidance: {
      priority: ['一页 A4 交付', '教育与实习完整性', '入选项目的岗位相关证据', 'HR 扫描清晰度', '荣誉', '技能', '装饰'],
      evidenceRule: '先保留背景、个人负责范围、动作、方法/技术、结果/指标、产物/链接等证据原子，再压缩或改写。',
      budget: {
        primaryExperienceBullets: '默认 3 条，按证据密度 2–4 条浮动；实习经历默认全部保留',
        secondaryExperienceBullets: '2–3，证据不足时不凑数；实习经历仍保留',
        primaryProjectBullets: '2–3',
        secondaryProjectBullets: '1–2',
        projectCount: '校招一页版默认 2 个，最多 3 个；按岗位相关性和证据强度筛选',
        renderedBulletLines: '通常 1–2 行',
      },
      pageRule: '一页 A4 是硬交付目标；超页时先微调和改造模板，再压缩技能、荣誉细节、重复和低相关表达，不得先删教育、实习或入选项目。',
    },
    sections,
