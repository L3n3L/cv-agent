...
function safeWorkflowEvent(event) {
  ...
  const allowed = ['event', 'timestamp', 'sessionId', 'runId', 'taskId', 'workspaceId', 'resumeId', 'toolName', 'toolCallId', 'mode', 'executionMode', 'continuationRound', 'continuationBudget', 'outcome', 'durationMs', 'assistantChars', 'errorCode', 'contentVersion', 'templateRevision', 'renderId', 'state', 'phase', 'reasoningSummary', 'delta', 'messageId']
  const value = {}
